...
export const TALLY_SECURITY_COUNCIL_ABI = [
    { inputs: [], stateMutability: "nonpayable", type: "constructor" },
    { inputs: [], name: "CastVoteDisabled", type: "error" },
    { inputs: [], name: "Empty", type: "error" },
    {
        inputs: [
            { internalType: "uint256", name: "fullWeightDuration", type: "uint256" },
            { internalType: "uint256", name: "votingPeriod", type: "uint256" },
        ],
        name: "FullWeightDurationGreaterThanVotingPeriod",
        type: "error",
    },
    {
        inputs: [
            ...
            { internalType: "uint256", name: "availableVotes", type: "uint256" },
        ],
    ...
    { inputs: [{ internalType: "uint8", name: "support", type: "uint8" }], name: "InvalidSupport", type: "error" },
    {
        inputs: [
            { internalType: "uint256", name: "nomineesLength", type: "uint256" },
            { internalType: "uint256", name: "weightsLength", type: "uint256" },
        ],
        name: "LengthsDontMatch",
        type: "error",
    },
    { inputs: [{ internalType: "address", name: "account", type: "address" }], name: "NotAContract", type: "error" },
    { inputs: [{ internalType: "address", name: "nominee", type: "address" }], name: "NotCompliantNominee", type: "error" },
    {
        inputs: [
            { internalType: "uint256", name: "numNominees", type: "uint256" },
            { internalType: "uint256", name: "k", type: "uint256" },
        ],
        name: "NotEnoughNominees",
        type: "error",
    },
    { inputs: [], name: "OnlyNomineeElectionGovernor", type: "error" },
    { inputs: [], name: "ProposeDisabled", type: "error" },
    { inputs: [{ internalType: "uint256", name: "x", type: "uint256" }], name: "UintTooLarge", type: "error" },
    { inputs: [{ internalType: "uint256", name: "paramLength", type: "uint256" }], name: "UnexpectedParamsLength", type: "error" },
    {
        inputs: [
    ...
    {
        anonymous: false,
        inputs: [{ indexed: false, internalType: "uint256", name: "newFullWeightDuration", type: "uint256" }],
        name: "FullWeightDurationSet",
        type: "event",
    },
    { anonymous: false, inputs: [{ indexed: false, internalType: "uint8", name: "version", type: "uint8" }], name: "Initialized", type: "event" },
    {
    ...
    },
    {
        ...
        inputs: [
            ...
            { indexed: true, internalType: "address", name: "nominee", type: "address" },
            { indexed: false, internalType: "uint256", name: "votes", type: "uint256" },
            { indexed: false, internalType: "uint256", name: "weight", type: "uint256" },
            { indexed: false, internalType: "uint256", name: "totalUsedVotes", type: "uint256" },
            { indexed: false, internalType: "uint256", name: "usableVotes", type: "uint256" },
            { indexed: false, internalType: "uint256", name: "weightReceived", type: "uint256" },
        ],
    ...
    {
        inputs: [{ internalType: "uint256", name: "electionIndex", type: "uint256" }],
    ...
    {
        inputs: [
            { internalType: "contract ISecurityCouncilNomineeElectionGovernor", name: "_nomineeElectionGovernor", type: "address" },
            { internalType: "contract ISecurityCouncilManager", name: "_securityCouncilManager", type: "address" },
            { internalType: "contract IVotesUpgradeable", name: "_token", type: "address" },
            { internalType: "address", name: "_owner", type: "address" },
            { internalType: "uint256", name: "_votingPeriod", type: "uint256" },
            { internalType: "uint256", name: "_fullWeightDuration", type: "uint256" },
        ],
        name: "initialize",
        outputs: [],
        stateMutability: "nonpayable",
    ...
    {
        inputs: [],
        name: "nomineeElectionGovernor",
        outputs: [{ internalType: "contract ISecurityCouncilNomineeElectionGovernor", name: "", type: "address" }],
        stateMutability: "view",
        type: "function",
    },
    {
    ...
    {
        inputs: [{ internalType: "uint256", name: "electionIndex", type: "uint256" }],
        name: "proposeFromNomineeElectionGovernor",
        outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
        stateMutability: "nonpayable",
        type: "function",
    },
    ...
    { inputs: [], name: "renounceOwnership", outputs: [], stateMutability: "nonpayable", type: "function" },
    {
        ...
        outputs: [{ internalType: "contract ISecurityCouncilManager", name: "", type: "address" }],
        stateMutability: "view",
        type: "function",
    },
    {
        inputs: [
            { internalType: "address[]", name: "nominees", type: "address[]" },
            { internalType: "uint240[]", name: "weights", type: "uint240[]" },
            { internalType: "uint256", name: "k", type: "uint256" },
        ],
        name: "selectTopNominees",
        outputs: [{ internalType: "address[]", name: "", type: "address[]" }],
        stateMutability: "pure",
        type: "function",
    },
    {
        inputs: [{ internalType: "uint256", name: "newFullWeightDuration", type: "uint256" }],
        name: "setFullWeightDuration",
        outputs: [],
        stateMutability: "nonpayable",
        type: "function",
    },
